...
async function fetchData<K extends BaseNodeTypes>(
  ...
  if (!(entityType in ModelDefinitions)) {
    throw new Error("UnknownModelType");
  }
...
export default function EntityList() {
  ...
  const [data, { refetch, mutate }] = createRefetchableAsync(() => {
    if (!(params.modelType in ModelDefinitions)) {
      throw new Error("UnknownModelType");
    }
          ...
          <div class="mx-10 flex items-center justify-center pt-3">
            ...
            <Show when={deepSearchOn()}>
              ...
              >
                ...
                >
                  <Spinner type={SpinnerType.puff} color={colors.slate[700]} />
                </Show>
              </button>
            </Show>
            <button
