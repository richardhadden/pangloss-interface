...
from pangloss.exceptions import PanglossCLIError
    ...
    for lang_ in langs:
        ...
        if lang_ == "en":
            ...
            for field in model.field_definitions:
                if field.field_name in {"uuid", "type"}:
                    continue

                translation[field.field_name][lang]["verbose_name"] = titlecase(
                    field.field_name.replace("_", " ")
                )
                translation[field.field_name][lang]["verbose_name_plural"] = titlecase(
                    pluralizer.pluralize(field.field_name).replace("_", " ")
                )
                translation[field.field_name][lang]["description"] = ""
            ...
            for field in model.field_definitions:
                if field.field_name in {"uid", "real_type"}:
                    continue

                translation[field.field_name][lang]["verbose_name"] = ""
                translation[field.field_name][lang]["verbose_name_plural"] = ""
                translation[field.field_name][lang]["description"] = ""
