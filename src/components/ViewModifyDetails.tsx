...
import { ViewableTypesNames, HeadViewTypesMap } from "~/generated/types";
import { AiOutlineClockCircle } from "solid-icons/ai";
import { relativeDate } from "~/contexts/translation";
import { Show } from "solid-js";

type ViewModifiedDetailsProps<K extends ViewableTypesNames> = {
  data: HeadViewTypesMap[K];
};

export function ViewModifiedDetails<K extends keyof HeadViewTypesMap>(
