    ...
    <Portal mount={document.getElementById("controlBar") as HTMLDivElement}>
      <div class="h-full w-full flex">
        <Show when={props.entityType}>
          <div class="h-14 uppercase font-semibold py-1 px-6 bg-emerald-700 text-emerald-50 rounded-bl-sm flex flex-col justify-center  border-r-[0.5px] border-r-white">
            {props.entityType}
          </div>
        </Show>
        <Show
        ...
        <button class="aspect-square bg-green-600 text-orange-50 w-14 last-of-type:rounded-br-sm hover:bg-orange-800 active:bg-orange-700">
          X
        </button>
      </div>
    </Portal>
